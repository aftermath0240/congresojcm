document.addEventListener('DOMContentLoaded', function() {
  ...
  const pageStyles = {
    '111.html': {
      'body': {
        backgroundImage: 'linear-gradient(45deg, #1a1a1a, #0d0c0c)',
      },
      '.navbar': {
        backgroundColor: '#2c2c2c',
      },
      '.galeria': {
        borderLeft: '3px solid #F7CAC9',
      },
    },
    '112.html': {
      'body': {
        backgroundImage: 'linear-gradient(to right, #0d0c0c, #1a1a1a)',
      },
      '.navbar': {
        borderBottom: '2px solid #F7CAC9',
      },
      '.galeria': {
        borderTop: '3px solid #F7CAC9',
      },
    },
    '113.html': {
      'body': {
  ...
  if (pageStyles[currentPage]) {
    applyStyles(pageStyles[currentPage]);
  }
...
// luna:comida favorita? PENE
// Frank: 32 de esmeralda por full diamante 